...
all_approaches = ["naive", "fr", "cacheblend-15", "kvlink-1"]
...
if __name__ == '__main__':
    fig, axs = plt.subplots(4, 1, figsize=(6, 3.5), dpi=300)
    norm = TwoSlopeNorm(vmin=0, vcenter=0.5, vmax=1)

    for i in range(4):
        approach_name = all_approaches[i]
        ax = axs[i]
    ...
    # fig.colorbar(cax)
    plt.tight_layout()
    plt.savefig("results/fig-algo-attnmap.png", format="png", bbox_inches="tight", dpi=300)